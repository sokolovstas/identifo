...
export class IdentifoForm {
        ...
        return (h("div", { class: "login-form" },
          ...
          this.federatedProviders.length > 0 && (h("div", { class: "social-buttons" },
            ...
            h("div", { class: "social-buttons__social-medias" },
              this.federatedProviders.indexOf('apple') > -1 && (h("div", { class: "social-buttons__media", onClick: () => this.loginWith('apple') },
                h("img", { src: getAssetPath(`assets/images/${'apple.svg'}`), class: "social-buttons__image", alt: "login via apple" }))),
              this.federatedProviders.indexOf('google') > -1 && (h("div", { class: "social-buttons__media", onClick: () => this.loginWith('google') },
                h("img", { src: getAssetPath(`assets/images/${'google.svg'}`), class: "social-buttons__image", alt: "login via google" }))),
              this.federatedProviders.indexOf('facebook') > -1 && (h("div", { class: "social-buttons__media", onClick: () => this.loginWith('facebook') },
  ...
  render() {
    return (h(Host, null,
      h("div", { class: { 'wrapper': this.theme === 'light', 'wrapper-dark': this.theme === 'dark' } }, this.renderRoute(this.route)),
  ...
  static get properties() { return {
    "route": {
      ...
      "complexType": {
        "original": "Routes",
        "resolved": "\"callback\" | \"error\" | \"loading\" | \"login\" | \"logout\" | \"otp/login\" | \"password/forgot\" | \"password/forgot/success\" | \"password/reset\" | \"register\" | \"tfa/setup\" | \"tfa/verify\"",
        "references": {
          "Routes": {
            "location": "local"
          }
