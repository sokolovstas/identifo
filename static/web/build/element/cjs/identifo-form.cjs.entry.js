...
const IdentifoForm = class {
  ...
  renderRoute(route) {
    ...
    switch (route) {
      case 'login':
        return (index.h("div", { class: "login-form" }, index.h("p", { class: "login-form__register-text" }, "Don't have an account?", index.h("a", { onClick: () => this.openRoute('register'), class: "login-form__register-link" }, ' ', "Sign Up")), index.h("input", { type: "text", class: `form-control ${this.lastError && 'form-control-danger'}`, id: "floatingInput", value: this.username, placeholder: "Email", onInput: event => this.usernameChange(event), onKeyPress: e => !!(e.key === 'Enter' && this.username && this.password) && this.signIn() }), index.h("input", { type: "password", class: `form-control ${this.lastError && 'form-control-danger'}`, id: "floatingPassword", value: this.password, placeholder: "Password", onInput: event => this.passwordChange(event), onKeyPress: e => !!(e.key === 'Enter' && this.username && this.password) && this.signIn() }), !!this.lastError && (index.h("div", { class: "error", role: "alert" }, (_a = this.lastError) === null || _a === void 0 ? void 0 : _a.detailedMessage)), index.h("div", { class: `login-form__buttons ${!!this.lastError ? 'login-form__buttons_mt-32' : ''}` }, index.h("button", { onClick: () => this.signIn(), class: "primary-button", disabled: !this.username || !this.password }, "Login"), index.h("a", { onClick: () => this.openRoute('password/forgot'), class: "login-form__forgot-pass" }, "Forgot password")), index.h("div", { class: "social-buttons" }, index.h("p", { class: "social-buttons__text" }, "or continue with"), index.h("div", { class: "social-buttons__social-medias" }, index.h("div", { class: "social-buttons__media" }, index.h("img", { src: index.getAssetPath(`assets/images/${'apple.svg'}`), class: "social-buttons__image", alt: "login via apple" })), index.h("div", { class: "social-buttons__media" }, index.h("img", { src: index.getAssetPath(`assets/images/${'google.svg'}`), class: "social-buttons__image", alt: "login via google" })), index.h("div", { class: "social-buttons__media" }, index.h("img", { src: index.getAssetPath(`assets/images/${'fb.svg'}`), class: "social-buttons__image", alt: "login via facebook" }))))));
      case 'register':
        return (index.h("div", { class: "register-form" }, index.h("input", { type: "text", class: `form-control ${this.lastError && 'form-control-danger'}`, id: "floatingInput", value: this.username, placeholder: "Email", onInput: event => this.usernameChange(event), onKeyPress: e => !!(e.key === 'Enter' && this.password && this.username) && this.signUp() }), index.h("input", { type: "password", class: `form-control ${this.lastError && 'form-control-danger'}`, id: "floatingPassword", value: this.password, placeholder: "Password", onInput: event => this.passwordChange(event), onKeyPress: e => !!(e.key === 'Enter' && this.password && this.username) && this.signUp() }), !!this.lastError && (index.h("div", { class: "error", role: "alert" }, (_b = this.lastError) === null || _b === void 0 ? void 0 : _b.detailedMessage)), index.h("div", { class: `register-form__buttons ${!!this.lastError ? 'register-form__buttons_mt-32' : ''}` }, index.h("button", { onClick: () => this.signUp(), class: "primary-button", disabled: !this.username || !this.password }, "Continue"), index.h("a", { onClick: () => this.openRoute('login'), class: "register-form__log-in" }, "Go back to login"))));
      case 'otp/login':
        return (index.h("div", { class: "otp-login" }, index.h("p", { class: "otp-login__register-text" }, "Don't have an account?", index.h("a", { onClick: () => this.openRoute('register'), class: "login-form__register-link" }, ' ', "Sign Up")), index.h("input", { type: "phone", class: "form-control", id: "floatingInput", value: this.phone, placeholder: "Phone number", onInput: event => this.phoneChange(event) }), index.h("button", { onClick: () => this.openRoute('tfa/verify'), class: "primary-button", disabled: !this.phone }, "Continue"), index.h("div", { class: "social-buttons" }, index.h("p", { class: "social-buttons__text" }, "or continue with"), index.h("div", { class: "social-buttons__social-medias" }, index.h("div", { class: "social-buttons__media" }, index.h("img", { src: index.getAssetPath(`./assets/images/${'apple.svg'}`), class: "social-buttons__image", alt: "login via apple" })), index.h("div", { class: "social-buttons__media" }, index.h("img", { src: index.getAssetPath(`./assets/images/${'google.svg'}`), class: "social-buttons__image", alt: "login via google" })), index.h("div", { class: "social-buttons__media" }, index.h("img", { src: index.getAssetPath(`./assets/images/${'fb.svg'}`), class: "social-buttons__image", alt: "login via facebook" }))))));
      case 'tfa/setup':
  ...
  render() {
    return index.h("div", { class: { 'wrapper': this.theme === 'light', 'wrapper-dark': this.theme === 'dark' } }, this.renderRoute(this.route));
  }
