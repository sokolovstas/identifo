...
func (ar *Router) initRoutes() {
	...
	ar.router.HandleFunc("/auth/federated", ar.FederatedLogin()).Methods("POST")
	ar.router.HandleFunc("/auth/federated", ar.FederatedLogin()).Methods("GET")

	ar.router.HandleFunc("/auth/federated/complete", ar.FederatedLoginComplete()).Methods("GET")
	ar.router.HandleFunc("/auth/federated/complete", ar.FederatedLoginComplete()).Methods("POST")
